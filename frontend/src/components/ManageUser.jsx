...
const UserActions = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen space-y-4 px-4">
      ...
      <Link
        to="/add-user"
        className="flex items-center justify-center w-full sm:w-2/3 md:w-1/3 py-3 px-4 
      ...
      <Link
        to="/delete-user"
        className="flex items-center justify-center w-full sm:w-2/3 md:w-1/3 py-3 
        px-4 bg-red-600 text-white rounded-md hover:bg-red-700 transition duration-200 font-semibold space-x-2"
      >
